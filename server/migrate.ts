...
// Read existing data from News.tsx and achievements.ts
const newsData = [
  {
    date: '2025-08-22',
...
async function migrate() {
  ...
  if (existingNews.count > 0 || existingAchievements.count > 0) {
    console.log('Data already exists. Skipping migration.');
    console.log(`News items: ${existingNews.count}, Achievements: ${existingAchievements.count}`);
    return;
  }
  ...
  console.log('Migrated all achievements');
